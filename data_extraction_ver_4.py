...
file = mne.io.read_raw_eeglab("Participant4_Part4_SelectData.set")
...
numpy.savetxt('final_input_data_with_labels_4_4_800_1800.csv', final_input_data_with_labels, delimiter=',')	
