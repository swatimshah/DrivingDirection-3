...
file = mne.io.read_raw_eeglab("Participant3_Part3_SelectData.set")
...
numpy.savetxt('final_input_data_with_labels_3_3_800_1800.csv', final_input_data_with_labels, delimiter=',')	
