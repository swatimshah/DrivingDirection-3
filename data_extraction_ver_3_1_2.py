...
# Find all the 91 events corresponding to Left, Right and Straight 
...
combined_events_and_labels = numpy.append(annot_filtered[0:91,:], my_labels.reshape(3, 91).transpose(), axis=1)
...
final_input_data_with_labels = numpy.append(final_input_data, combined_events_and_labels[:, 1].reshape(91, 1), axis=1)
numpy.savetxt('final_input_data_with_labels_1_2_800_1800.csv', final_input_data_with_labels, delimiter=',')	
