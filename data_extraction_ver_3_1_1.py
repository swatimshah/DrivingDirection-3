...
file = mne.io.read_raw_eeglab("Participant1_Part1_SelectData_EEGLab.set")
...
numpy.savetxt('final_input_data_with_labels_1_1_800_1800.csv', final_input_data_with_labels, delimiter=',')	
